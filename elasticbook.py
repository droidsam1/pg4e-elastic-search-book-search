...
# if bookfile.strip() == '':
#     raise Exception(
#         "empty string detected, please try again to enter a book file")
...
# load the file backwards to not wait for the process to reach the end of the book
with FileReadBackwards('pg14091.txt', encoding="utf-8") as frb:
    for line in frb:
        count = count + 1
        line = line.strip()
